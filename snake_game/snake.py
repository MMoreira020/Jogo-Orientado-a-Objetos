...
class SNAKE:
    def __init__(self):
        ...
        self.direction = Vector2(1, 0)  # Direção inicial
        self.new_block = False
        self.lives = 3  # Adiciona o atributo de vidas
    ...
    def reset(self):
        ...
        self.direction = Vector2(1, 0)  # Resetar a direção
...
class MAIN:
    ...
    def draw_elements(self):
        ...
        self.draw_score()
        self.snake.draw_lives()  # Desenha as vidas
    ...
    def game_over_screen(self):
        while True:
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_RETURN:
                        self.snake.reset()
                        self.snake.lives = 3  # Resetar as vidas
                        return  # Retorna para sair do loop e reiniciar o jogo

            screen.fill((175, 215, 70))
            # Desenhar o menu de game over
            ...
            retry_rect = retry_text.get_rect(center=(cell_number * cell_size // 2, cell_number * cell_size // 2))
...
# Manter o loop do jogo em execução
while True:
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            pygame.quit()
